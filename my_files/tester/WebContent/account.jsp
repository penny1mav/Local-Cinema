...
<body>
	...
	<a href="changename.jsp" class="button" style= "color:white"  > Change Username </a>
	<a href="changePwd.jsp" class="button"  style= "color:white"> Change Password </a>	
	<a href="deleteUser" class="button"  style= "color:white"> Delete Account </a>
